...
|**Model**|**Data와 Data를 가져오는 Logic**을 통틀어 이르는 말.의
...
#### → <u>Why not MVC : 비대해지는 UI Controller</u>
<p align="left">
...
#### → <u>State Holder : ViewModel vs. Presenter</u>
...
___
### 🧭 References
[1. 영문판 위키피디아 - Architectural Pattern](https://en.wikipedia.org/wiki/Architectural_pattern)
[2. Guide to App Architecture - Android Developer (4,6번 이미지 출처)](https://developer.android.com/jetpack/guide?hl=en)
[3. 안드로이드의 MVC, MVP, MVVM 종합 안내서](https://academy.realm.io/kr/posts/eric-maxwell-mvc-mvp-and-mvvm-on-android/)